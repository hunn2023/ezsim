                ...
                <Col lg={6}>
                  <div className="card-body">
                    ...
                    <div className="text-center mb-4">
                      <img src={user1} alt="thumbnail" className="rounded-circle img-thumbnail avatar-xxl mb-2" />
                    ...
                    <p className="text-muted text-center mt-4 mb-0">
                      Not you? Return to{' '}
                      <Link to="/auth-2/sign-in" className="text-decoration-underline link-offset-3 fw-semibold">
                        Sign in
                      </Link>
                    </p>
